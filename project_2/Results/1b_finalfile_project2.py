...
Original file is located at
    https://colab.research.google.com/drive/1BDUMWxob9iLpVoFDPBlRavov3ruswIoJ
"""

import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
import matplotlib.cm as cm  # Importa o módulo matplotlib.cm
import matplotlib.pyplot as plt
...
### 4-Gráfico de inflação por Continente
...
for i, pais in enumerate(country):  # Itera sobre cada país e seu índice na lista 'country'
    plt.scatter(countryData.loc[countryData['country'] == pais, "year"],  # Define os valores do eixo x (ano) para cada país
                ...
                s=countryData.loc[countryData['country'] == pais, 'Inflation'] * 10)  # Define o tamanho da bolha proporcional ao valor da inflação
